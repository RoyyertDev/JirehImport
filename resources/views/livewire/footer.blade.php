<footer class="w-full py-10 bg-[#1d1f20] flex flex-col justify-center items-center gap-4">
    <section class="w-5/6 mx-auto grid grid-cols-1 grid-rows-4 sm:grid-cols-[1fr_1fr_1fr_auto] justify-center gap-4">
        <article>
            ...
            <p class="text-zinc-400">
                En <span class="text-[#F2BB06] font-semibold italic">Jireh Import,</span> encontrarás una amplia
        ...
        <article>
            ...
            <div class="grid grid-cols-2 text-zinc-400 gap-x-8 gap-y-1">
                <a wire:navigate.hover class="hover:text-[#F2BB06] transition-all duration-300 w-auto"
                    href="{{ route('home') }}">Inicio</a>
                <a wire:navigate.hover class="hover:text-[#F2BB06] transition-all duration-300 w-auto"
                    href="{{ route('about') }}">Quienes somos</a>
                <a wire:navigate.hover class="hover:text-[#F2BB06] transition-all duration-300 w-auto"
                    href="http://">Productos</a>
                <a wire:navigate.hover class="hover:text-[#F2BB06] transition-all duration-300 w-auto"
                    href="http://">Carrito</a>
                <a wire:navigate.hover class="hover:text-[#F2BB06] transition-all duration-300 w-auto"
                    href="http://">Iniciar sesión</a>
                <a wire:navigate.hover class="hover:text-[#F2BB06] transition-all duration-300 w-auto"
                    href="http://">Registrarse</a>
                <a wire:navigate.hover class="hover:text-[#F2BB06] transition-all duration-300 w-auto"
                    href="http://">Instagram</a>
                <a wire:navigate.hover class="hover:text-[#F2BB06] transition-all duration-300 w-auto"
                    href="http://">Facebook</a>
                <a wire:navigate.hover class="hover:text-[#F2BB06] transition-all duration-300 w-auto"
                    href="http://">WhatsApp</a>
                <a wire:navigate.hover class="hover:text-[#F2BB06] transition-all duration-300 w-auto"
                    href="http://">Tiktok</a>
            </div>
        </article>
        <article>
            ...
            <form action="">
                <fieldset class="grid grid-cols-2 gap-4">
                    <input class="rounded-lg bg-[#0e0e0e] text-white border-none ring-[#F2BB06] focus:ring-offset-0"
                        type="text" id="nombre" name="nombre" placeholder="Nombre">
                    <input class="rounded-lg bg-[#0e0e0e] text-white border-none ring-[#F2BB06] focus:ring-offset-0"
                        type="email" id="email" name="email" placeholder="Email">
                    <textarea
                        class="col-span-2 rounded-lg bg-[#0e0e0e] text-white border-none ring-[#F2BB06] focus:ring-offset-0"
                        rows="3" id="mensaje" name="mensaje" placeholder="Mensaje"></textarea>
                    <button
                        class="col-start-2 text-zinc-400 hover:text-[#F2BB06] transition-all duration-300 border border-transparent hover:border-[#F2BB06] rounded-lg py-1.5 px-1 w-auto bg-[#0e0e0e]">Enviar</button>
                </fieldset>
            </form>
    ...
    <section class="w-5/6 mx-auto text-zinc-400">
        <p>
            Copyright © 2024 <span class="font-semibold text-[#F2BB06]">JirehImport.</span> Todos los derechos
            reservados.
        </p>
        <div>
