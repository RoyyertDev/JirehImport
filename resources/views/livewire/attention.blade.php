<section class="pb-10">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 2xl:grid-cols-4 gap-6">
        <figure
            class="rounded-lg overflow-hidden shadow-[0_3px_8px_-5px] shadow-[#F2BB06] hover:scale-105 transition-all duration-300">
        ...
        <figure
            class="rounded-lg md:col-start-2 md:col-end-2 2xl:col-auto overflow-hidden shadow-[0_3px_8px_-5px] shadow-[#F2BB06] hover:scale-105 transition-all duration-300">
